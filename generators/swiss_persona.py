...
def generate_persona(data, *, seed=None):
    ...
    return SwissPersona(first_name, last_name, age, years, 'unspecified',
                        primary_language, canton['name'], canton.get('major_city',''),
                        phone, email, title, rnd.choice(data['industries']))
