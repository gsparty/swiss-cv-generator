...
def _make_experience_history(years_experience: int, current_title: str = "Engineer"):
...
def generate_persona(
    ...
    persona = SwissPersona(
        ...
        experience=_make_experience_history(years_experience, current_title=rnd.choice(["Software Engineer","Analyst","Manager"])),
